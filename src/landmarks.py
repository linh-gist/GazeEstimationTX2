...
class landmarks:
    ...
    def __init__(self, config=config):
        ...
        self.landmarks_predictor = dlib.shape_predictor(
            './ext/Realtime-facial-landmark-detection/shape_predictor_68_face_landmarks.dat')
    ...
    def detect_dlib(self, rect, frame):
    ...
    def plot_markers_neat(self, image, faceLandmarks):
        ...
        def drawPoints(image, faceLandmarks, startpoint, endpoint, isClosed=False):
            ...
            cv2.polylines(image, [points], isClosed, (255, 0, 0), thickness=1, lineType=cv2.LINE_8)
